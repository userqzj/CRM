...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%--这里要把jstl jar包放在tomcat 的lib文件夹下--%>
<%
				...
				<table class="table table-hover">
					...
					<tbody id="clueBody">
						<%--<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=7ab82bf3f0e64af787119bfffa66e5f0';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
