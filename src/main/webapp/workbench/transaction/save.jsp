...
<script>
	...
	/*
		关于阶段和可能性
			...
			将来，我们通过stage以及对应关系 来取得可能性这个值
			这种需求在交易模块中需要大量的使用到

			所谓以我们就需要将该文件解析在服务器缓存中
			appliation.setAttribute(stage2Possibility.properties文件内容)
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden"  name="activityId" value="0939ba3397874594a42ec64c1c7561a2"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="ba3a53368adc4b21a193fe21b8c3eabd" name="contactsId"/>
			</div>
		</div>
