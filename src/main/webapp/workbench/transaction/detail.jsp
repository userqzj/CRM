...
<%@ page import="com.jlju.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.jlju.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeIcon(stage,index1) {
		...
		//如果当前阶段的可能性为0 前七个一定是黑圈 后两个一个是红叉一个是黑叉
		...
		//如果当前阶段的可能性不为0	前七个有可能绿圈 绿色标记 黑圈 后两个一定是黑叉
		}else {
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//判断当前阶段
			//如果当前阶段的可能性为0 前七个一定是黑圈，后两个一个是红×一个是黑×
		...
		<%
			...
			//如果当前阶段的可能性不为0 前七个有可能是绿圈，绿色标记，后两个一定是黑×
			}else {
		...
		%>
			...
			-----------
		<%
					//如果遍历出来的阶段的可能性不为0 说明是前七个阶段 绿圈 绿标记 黑圈
					}else {
