...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			/*
			操作模态窗口的方式：
				需要操作的模态窗口jquery对象，调用modal方法 为该方法传递参数 show：打开模态窗口 hide：关闭模态窗口
			 */

			//$("#createActivityModal").modal("show");

			//走后台 目的是为了取得用户信息列表为所有者下拉框铺值
            $.ajax({
					...
					if (data){
						...
						*/
						...
						/*
							...
							对于表单的jquery对象提供了submit方法 让我们提交表单
							但是表单的jquery对象没有为我们提供reset方法让我们重置表单

							虽然jquery对象没提供，但是原声js提供了reset方法
							所以我们要将jquery对象转换为原声js（dom）对象
	...
	/*
	    ...
	    在什么情况下 需要调用pageList方法
	    1.点击左侧 "市场活动"超链接 需要刷新市场活动列表
	    2.添加，修改，删除后 需要刷新市场活动列表
	    3.点击查询按钮的时候
	    4.点击分页组件的时候

	    以上为pageList方法制定了六个入口，也就是说在以上六个操作执行完毕后必须调用pageList方法，刷新市场活动列表
	 */
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
								<%--
									关于文本域textarea
										1.一定要以标签对形式来呈现，正常状态下标签对要紧紧挨着
										2.textarea虽然是以标签对的形式来呈现的，但是他也是属于表单元素范畴
											我们所有的对于textarea的取值和赋值的操作，应该统一使用val（）方法（而不是html方法）
								--%>
				...
				<div class="btn-group" style="position: relative; top: 18%;">
					<%--
						...
						data-target="#createActivityModal"
							要打开哪个模态窗口 通过#id的形式找到该窗口

						现在我们以属性和属性值方式写在了button元素中 用来打开模态窗口
						 问题：
						  没有办法对按钮的功能进行扩充

						 未来的实际项目开发对于触发模态窗口的操作不要写死在元素当中
						 应该由自己写js代码来操作
					--%>
